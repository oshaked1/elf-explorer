...
use crate::elf::{Description, Elf, ElfNAddr, ElfNOff, ProgramHeader32, ProgramHeader64};
use crate::{address_field, decimal_field, descriptive_field, offset_field, size_field, utils};

// Program header table methods
impl super::ElfExplorer {
    pub fn pheaders_init(&self) {
        self.pheaders_list.set_headers_enabled(true);
        self.pheaders_layout
            .add_child((0, 0), (100, 60), &self.pheaders_list);
        self.pheaders_init_colummns();

        self.phdr_frame.set_visible(false);
        self.pheaders_layout
            .add_child((0, 60), (100, 40), &self.phdr_frame);
        self.phdr_init();
    }
...
impl super::ElfExplorer {
    pub fn phdr_init(&self) {
        ...
        self.phdr_layout
            .add_child((0, 0), (100, 100), &self.phdr_list);
